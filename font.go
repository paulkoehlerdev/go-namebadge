...
var letters = []rune("ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0987654321^ !\"\000$%&/()=?` °\\}][{@ ~ |<>,;.:-_#'+* äöüÄÖÜßàäòöùüèéêëôöûîïÿçÀÅÄÉÈÊËÖÔÜÛÙŸ")

func letterFromRune(r rune) []byte {
	idx := -1
	...
	return fontLut[idx*nPixelsHeight : idx*nPixelsHeight+nPixelsHeight]
}
